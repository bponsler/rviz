...
class WrenchStampedDisplay: public rviz::MessageFilterDisplay<geometry_msgs::msg::WrenchStamped>
{
    Q_OBJECT
public:
...
private:
    ...
    void processMessage( const geometry_msgs::msg::WrenchStamped::SharedPtr msg );
